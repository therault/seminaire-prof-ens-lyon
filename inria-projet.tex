\section{Research Program and Integration in TOPAL}
...
\frame{
  ...
  \begin{center}
    \textcolor{red}{Mid-term goals: evaluate how this can apply to DNN training (2nd TOPAL application domain)}
  \end{center}
}
...
\frame{
  ...
  \begin{center}
    \textcolor{red}{Possible collaborations with STORM; complement the expertise in TOPAL}
  \end{center}
}
...
\frame{
  \frametitle{Looking back at hierarchical/noncoordinated checkpointing}
    ...
    \begin{center}
      \textcolor{red}{Long term goal: New theme in TOPAL. Possible collaborations with CONCACE, STORM and TADAAM}
    \end{center}
}
